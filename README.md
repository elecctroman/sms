...
## Hızlı Başlangıç
1. Dosyaları FTP ile sunucuya yükleyin.
2. `https://alanadiniz.com/install/install.php` adresini ziyaret edip sihirbazı tamamlayın.
...
- E-posta OTP ile iki aşamalı doğrulama.
