...
- Hafif PHP tabanlı tema motoru (landing ve admin için ayrı düzenler)
...
- Composer zorunlu değildir; proje dahili otomatik yükleyici ile çalışır.

### Adımlar

1. Depoyu klonlayın ve isterseniz ön yüz varlıkları için NPM bağımlılıklarını yükleyin:
...
Araçların sisteminizde global olarak bulunması gerekir. Kod kapsamı raporu oluşturmak için PHPUnit’e `--coverage-html build/coverage` parametresini ekleyin.
...
- Projede özel bir PSR-4 uyumlu otomatik yükleyici kullanılmaktadır.
